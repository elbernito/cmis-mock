...
/**
 * Entity representing a CMIS 1.2 TypeDefinition object.
 */
@Entity
@Table(name = "type_definitions")
public class TypeDefinitionModel extends CmisObjectModel {
    private static final Logger logger = LoggerFactory.getLogger(TypeDefinitionModel.class);

    /**
     * Parent type id (optional, null for base types).
     */
